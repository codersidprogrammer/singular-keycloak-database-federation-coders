...
public class DBUserStorageProvider implements UserStorageProvider,
    ...
    // -------------------------------------------------------------------------
    // UserLookupProvider  (Keycloak 24: realm is the first parameter)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // UserQueryProvider  (Keycloak 24: Stream-based API)
    // -------------------------------------------------------------------------
    ...
    @Override
    @SuppressWarnings("deprecation")  // String-based search deprecated in Keycloak 24; Map-based overload is preferred
    public Stream<UserModel> searchForUserStream(RealmModel realm, String search, Integer firstResult, Integer maxResults) {
        ...
        PagingUtil.Pageable pageable = (firstResult != null && maxResults != null)
                ? new PagingUtil.Pageable(firstResult, maxResults) : null;
        return internalSearchForUser(search, realm, pageable);
    }
    ...
    public Stream<UserModel> searchForUserStream(RealmModel realm, Map<String, String> params, Integer firstResult, Integer maxResults) {
        ...
        String search = params.values().stream().findFirst().orElse(null);
        PagingUtil.Pageable pageable = (firstResult != null && maxResults != null)
                ? new PagingUtil.Pageable(firstResult, maxResults) : null;
        return internalSearchForUser(search, realm, pageable);
    }
    ...
    public Stream<UserModel> getGroupMembersStream(RealmModel realm, GroupModel group, Integer firstResult, Integer maxResults) {
        log.infov("search for group members: realm={0} groupId={1} firstResult={2} maxResults={3}", realm.getId(), group.getId(), firstResult, maxResults);
        return Stream.empty();
    }

    @Override
    public Stream<UserModel> searchForUserByUserAttributeStream(RealmModel realm, String attrName, String attrValue) {
        log.infov("search for users by attribute: realm={0} attrName={1} attrValue={2}", realm.getId(), attrName, attrValue);
        return Stream.empty();
    }
    ...
    public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
        ...
        if (allowDatabaseToOverwriteKeycloak
                && user instanceof CachedUserModel
    ...
    public UserModel addUser(RealmModel realm, String username) {
        // Returning null skips this provider and calls the next one.
        return null;
    }
    ...
    public boolean removeUser(RealmModel realm, UserModel user) {
        ...
        if (userRemoved) {
            log.infov("deleted keycloak user: realm={0} userId={1} username={2}",
                    realm.getId(), user.getId(), user.getUsername());
        }
        return userRemoved;
    }
}
